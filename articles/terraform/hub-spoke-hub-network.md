...
ハブ仮想ネットワークは、オンプレミス ネットワークへの主要な接続ポイントとして機能します。 この仮想ネットワークでは、スポーク仮想ネットワーク内でホストされるワークロードによって使用される共有サービスをホストします。 デモの目的で、この記事では共有サービスは実装されていません。
